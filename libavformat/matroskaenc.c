...
static int mkv_write_tracks(AVFormatContext *s)
{
    ...
    for (i = 0; i < s->nb_streams; i++) {
        ...
        int display_width_scale_factor = 1;
        ...
        switch (codec->codec_type) {
            case AVMEDIA_TYPE_VIDEO:
                ...
                if (st->sample_aspect_ratio.num) {
                    ...
                    put_ebml_uint(pb, MATROSKA_ID_VIDEODISPLAYWIDTH , d_width/display_width_scale_factor);
                    put_ebml_uint(pb, MATROSKA_ID_VIDEODISPLAYHEIGHT, codec->height);
                } else if (display_width_scale_factor != 1){
                    put_ebml_uint(pb, MATROSKA_ID_VIDEODISPLAYWIDTH , codec->width/display_width_scale_factor);
                    put_ebml_uint(pb, MATROSKA_ID_VIDEODISPLAYHEIGHT, codec->height);
                }
